        ...
        return (
            <SiteContainer>
                ...
                <div className="doc-header-links">
                    ...
                    <a href="https://pre-production-app.boldid.net/bi/embedded/register?plan=95&evaluation=v2" target="_blank" role="button"><div class="header-demo-link">Start Free Trial</div></a>
                </div>
            </SiteContainer>
        )
    }
