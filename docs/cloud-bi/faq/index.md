...
[How to standardize column name from different data sources?](/cloud-bi/faq/how-to-standardize-column-name-from-different-data-sources/)

[How to apply linking configured with Stored Procedure?](/cloud-bi/faq/how-to-apply-linking-configured-with-stored-procedure/)
...
[How to transpose the data columns and rows in SQL data source?](/cloud-bi/faq/how-to-transpose-the-data-columns-and-rows-in-sql-data-source/)
