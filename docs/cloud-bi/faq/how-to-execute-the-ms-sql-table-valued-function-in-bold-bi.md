---
layout: post
title: Execute MS SQL table-valued function | Bold BI Docs
description: Learn the steps how to execute the Microsoft SQL table-valued function in Bold BI Cloud based Web designer.
platform: bold-bi
documentation: ug
---
