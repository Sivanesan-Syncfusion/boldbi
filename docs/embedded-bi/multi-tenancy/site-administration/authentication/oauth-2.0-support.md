...
OAuth 2.0 can be set as default authentication when [OAuth 2.0 settings](/embedded-bi/multi-tenancy/site-administration/authentication/oauth-2.0-support/#steps-to-configure-oauth-20-in-bold-bi) is enabled.
