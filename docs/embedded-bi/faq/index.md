...
[How to change the user after installation Bold BI on Linux?](/embedded-bi/faq/Change-the-user-after-installing-Bold-BI-on-Linux/)
...
[what-are-the-database-permissions-required-to-set-up-bold-bi-embedded?](/embedded-bi/faq/what-are-the-database-permissions-required-to-set-up-bold-bi-embedded/)

[How to add a new data connector under Bold BI?](/embedded-bi/faq/how-to-add-a-new-data-connector-under-bold-bi/)

[How to standardize column name from different data sources?](/embedded-bi/faq/how-to-standardize-column-name-from-different-data-sources/)

[How to apply linking configured with Stored Procedure?](/embedded-bi/faq/how-to-apply-linking-configured-with-stored-procedure/)
...
[How to transpose the data columns and rows in SQL data source?](/embedded-bi/faq/how-to-transpose-the-data-columns-and-rows-in-sql-data-source/)
